<footer class="main-footer position-relative z-index-1 padding-top-xl">
  <div class="container max-width-lg">
    ...
    <div class="container max-width-md">
      ...
      <nav class="footerLinks col-9@lg order-1@lg">
  ...
  <script src="/codyhouse-framework/main/assets/js/carousel.js"></script>
  <script src="/codyhouse-framework/main/assets/js/navbar.js"></script>
  <script src="/codyhouse-framework/main/assets/js/tabs.js"></script>
